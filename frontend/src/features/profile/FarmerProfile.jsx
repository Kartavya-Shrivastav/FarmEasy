        ...
        <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-[#6B6B6B]">
              {isOwnProfile ? 'Manage your farmer account' : 'View farmer details'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="border-t border-[#E5DED3] pt-6 mb-6">
                    <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-4 text-center">
                      ...
                      <p className="text-sm text-[#6B6B6B]">
                        Based on {profile.totalReviews || 0} review{profile.totalReviews !== 1 ? 's' : ''}
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-sm font-medium text-[#6B6B6B] mb-2">Total Auctions</p>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-sm font-medium text-[#6B6B6B] mb-2">Active Auctions</p>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-sm font-medium text-[#6B6B6B] mb-2">Completed Sales</p>
              ...
              {isOwnProfile && (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <p className="text-sm font-bold text-white/90 mb-2">Total Earnings</p>
              ...
              {isOwnProfile && stats?.pendingPayments > 0 && (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-[#6B6B6B] mb-2">Pending Payments</p>
                      <p className="text-4xl font-bold text-orange-600 mb-1">{stats.pendingPayments}</p>
                      <p className="text-xs text-[#6B6B6B]">Waiting for buyer payment</p>
                    </div>
          ...
          {profile?.reviews && profile.reviews.length > 0 && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-[#2D2D2D]">Reviews from Buyers</h2>
              </div>
                  ...
                  >
                    ...
                    <div className="pt-3 border-t border-[#E5DED3]">
                      <p className="text-xs text-[#6B6B6B] flex items-center gap-1">
                        ...
                        Auction: <span className="font-medium text-[#2D2D2D]">{review.auction?.title}</span>
                      </p>
                    </div>
                  </div>
                ))}
          ...
          {isOwnProfile && (
            ...
            >
              <h3 className="text-lg font-bold text-[#2D2D2D] mb-4">Quick Actions</h3>
